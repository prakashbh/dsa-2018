...
void initialize_stacks(STACK *ps1, STACK *ps2)
{
    ...
    ps1->top++;
    strcpy(ps1->items[3].message_data,"Kids Section");
    ps1->items[3].hour[0] = 10;
    ps1->items[3].hour[1] = 5;

    ps1->top++;
    strcpy(ps1->items[4].message_data,"Coffee Time!");
    ps1->items[4].hour[0] = 9;
    ps1->items[4].hour[1] = 6;

    ps1->top++;
    strcpy(ps1->items[5].message_data,"Delicious Snacks!");
    ps1->items[5].hour[0] = 8;
    ps1->items[5].hour[1] = 7;
